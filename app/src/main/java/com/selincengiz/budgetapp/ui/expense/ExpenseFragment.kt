package com.selincengiz.budgetapp.ui.expense
...
import com.selincengiz.budgetapp.databinding.FragmentExpenseBinding
...
class ExpenseFragment : Fragment(), ItemListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        fireBaseLiveExpenseRead()
    }

    fun fireBaseLiveExpenseRead() {

        FirebaseUtils.db.collection("users").document(FirebaseUtils.auth.currentUser!!.email!!)
            .collection("income_expense").whereEqualTo("incomeExpenseType", false)
